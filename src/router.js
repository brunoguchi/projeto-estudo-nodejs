...
//VLOZ CORE CONTROLLER
router.get('/api/integracao/adquirentes/:adquirenteId/clientes-ativos', vlozCoreController.obterClientesAtivos);
router.get('/api/integracao/clientes-ativos', (req, res) => vlozCoreController.obterClientesAtivos(req, res, 2, false));
